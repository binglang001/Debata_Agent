...
_RAW_PROMPT_DUMP_ENV = "DEBATA_KV_RAW_PROMPT_DUMP"
_RAW_PROMPT_DUMP_DIR_ENV = "DEBATA_KV_RAW_PROMPT_DUMP_DIR"
_RAW_PROMPT_DUMP_DEFAULT_DIR = Path("data/logs/kv_raw_prompts")
_REPLAY_REASONING_ENV = "DEBATA_OPENAI_COMPAT_REPLAY_REASONING_CONTENT"
