    ...
    async def _build_turn_messages(
        ...
        *,
        ...
        prompt = (
            ...
            "affinity 是 0-100 的目标绝对亲近度，不是 0-1，也不是 1-10；AI 可以在有把握时填写以覆盖当前值；"
            "刻度锚点：0=陌生/排斥，30=疏离，50=普通熟人，70=信任友好，85=亲近在意，95=核心亲密关系。"
            "首次建档若关系正常，应以 60/100 作为中性友好基线，不要从 0 起步。"
            ...
            "relationship/affinity_delta 是本轮增减分，普通一轮互动可优先使用 affinity_delta，但不是唯一选项；普通一轮互动通常 -5 到 +5；强烈事件可更大，但要写 reason。"
            "已有关系写低绝对 affinity 意味着明确关系降温，需要有上下文依据。"
